    ...
    public class Help
    {
        public static void ExibirManualDoUtilizador(Guid userId, string utilizador)
        {
            ...
            while (again)
            {
                ...
                Console.WriteLine("1- Registrar Limpeza, Exclusão e Consulta das Áreas");
                Console.WriteLine("2- Sobre os Utilizadores");
                Console.WriteLine("3- Sobre as Residências");
                Console.WriteLine("4- Sobre os Andares (Pisos)");
                Console.WriteLine("5- Sobre as Áreas (Divisões)");
                Console.WriteLine("6- Mensagens de Erros Comuns");
